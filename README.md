...
- `posts/stamp-credit-assignment.html`：STAMP 的证据溯源信用分配
- `posts/tree-grpo-credit-assignment.html`：Tree-GRPO 的树状 Rollout 与信用分配
- `posts/pica-credit-assignment.html`：PiCA 的 pivot 过程奖励与训练流程
